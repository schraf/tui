...
void TUI_DrawChar(TUI_Context ctx, int x, int y, char c);
...
void TUI_FillRect(TUI_Context ctx, int x, int y, int w, int h, char c);
void TUI_DrawHLine(TUI_Context ctx, int x, int y, int len, char c);
void TUI_DrawVLine(TUI_Context ctx, int x, int y, int len, char c);
